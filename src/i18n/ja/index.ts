                        ...
                        h3: {
                            ...
                            1: {
                                ...
                                center_box: {
                                    text1: '【サーバー選択について】',
                                    img: 'server_desc',
                                    text2: 'Rainサーバーには、Rain (JP)[日本・東京都]、Rain (US)[アメリカ合衆国・ニューヨーク州ニューヨーク市]、Rain (EU)[ドイツ連邦共和国・ヘッセン州フランクフルト]の3サーバーが存在します。しかしながら、各々のサーバーが独立している訳ではなく、上記イメージ図のように、全てが1つのメインサーバーへ接続されているため、基本的にはどのサーバーから接続してもログイン先は同じとなります。しかし、お住まいの国・地域とサーバー間の距離が遠くなるにつれ、プレイ時にPing値が高くなる傾向（遅延発生）があり、サーバー選択時には出来る限りお住まいの地域から距離が最も近いサーバーを選択することをお勧めします。',
                                },
                            },
