                            ...
                            },
                            {
                                ...
                                img_desc: [
                                    ...
                                    },
                                    {
                                        item_title: '②圧縮テクスチャ',
                                        item_text:
                                            'DXTC（画像圧縮アルゴリズム）の有効もしくは無効を選択します。<ul><li class="img_desc_section_text_list"><span>有効：</span><span>画像処理は速くなる一方、画像細部が粗くなります。</span></li><li class="img_desc_section_text_list"><span>無効：</span><span>画像処理は遅くなる一方、画像細部が高精細になります。</span>',
                                    },
                                ],
                            },
                            {
                                ...
                                img_desc: [
                                    {
                                        item_title: '①音量設定',
                                        item_text: '3種のゲームウィンドウ（「通常（アクティブ時）」「非アクティブ時」「最小化時」）それぞれに応じて、各音量をスライダにより調節することができます。',
                                    },
                                    {
                                        item_title: '②サンプリングレート',
                                        item_text:
                                            'ご使用のサウンドカードに合わせてサンプリングレートおよびバッファサイズを設定できます。<ul><li class="img_desc_section_text_list"><span>サンプリングレート：</span><span>音声などのアナログ信号をデジタル信号に変換するために行う単位時間あたりの処理回数を表す値のことです。一般的に、この値が高くなるにつれ、音質の向上が見込まれるものの、その分データ量も増加するため、ストレージや帯域幅に影響を与えます。一方、値が極度に低くなれば、音質の低下や不自然な音を引き起こす可能性があります。</span></li><li class="img_desc_section_text_list"><span>バッファサイズ：</span><span>あらかじめ一定量のデータを一時的に読み込んでおく領域のの大きさのことを指します。この値が大きいと、音声再生までの待ち時間が長くなるものの、音飛びは発生しづらくなります。一方、値が小さいと、音声再生までの待ち時間は短くなりますが、音飛びが発生しやすくなります。</span></li></ul>',
                                    },
                                ],
                            },
                            {
