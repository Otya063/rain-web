<script lang="ts">
    ...
    const managementAndServiceInfoData = data.managementAndService;
    const ingameEventsInfoData = data.ingameEvents;
    const updatesAndMaintenanceInfoData = data.updatesAndMaintenance;
